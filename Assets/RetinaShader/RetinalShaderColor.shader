Shader "Retinal/Color Retinal Shader"
{
    Properties
    {
        ...
        SubShader
    {
        ...
        Pass
        {
            ...
            fixed4 frag (v2f IN) : SV_Target
            {
                ...
                //result.r = 0.5f + (final_color_current.r - final_color_previous.r);
                //result.g = 0.5f + (final_color_current.g - final_color_previous.g);
                //result.b = 0.5f + (final_color_current.b - final_color_previous.b);;
